...
@implementation UITabBarController (CCExtension)
+ (void)load {
    SEL selectors[] = {
...
- (NSInteger)CC_selectedIndex {
    NSInteger index = [self CC_selectedIndex];
...
@implementation UINavigationController (CCExtension)
// 是否支持自动转屏
- (BOOL)shouldAutorotate {
